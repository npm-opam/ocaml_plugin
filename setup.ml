(* OASIS_START *)
(* DO NOT EDIT (digest: dfbd9fe28033a6533ac757ed849e59c7) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights =
            [
               "(C) 2013-2016 Jane Street Group LLC <opensource@janestreet.com>"
            ];
          maintainers =
            ["Jane Street Group"; "LLC <opensource@janestreet.com>"];
          authors = ["Jane Street Group"; "LLC <opensource@janestreet.com>"];
          homepage = Some "https://github.com/janestreet/ocaml_plugin";
          ...
          sections =
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources = ["ocaml_fake_archive.c"];
                      bs_data_files = [];
               ...
               Library
                 ({
                     cs_name = "ocaml_plugin_ocamlbuild";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Ocaml_plugin_ocamlbuild"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Executable
                 ({
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "ocaml_embed_compiler.ml"
                   })
            ];
          plugins =
            [
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "z\148n\223\239Y\228p\r\234Y\n\217\025\021\t";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
